...
#The letter s represents the format of genome number in the first column and gene number in the second column (eg. the annotation results of the caiTABCDE database)
